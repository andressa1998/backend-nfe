...
function gerarXmlNfe(dados) {
    ...
    enderDest.ele('cMun').txt(destinatario.cMun || '4101804').up(); // fallback opcional
    ...
    // ========== RESPONSÁVEL TÉCNICO (OBRIGATÓRIO PARA SOFTWARE PRÓPRIO) ==========
    ...
    console.log('🏁 XML final gerado com sucesso. Tamanho:', xmlString.length);
